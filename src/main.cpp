...
static bool
parse_cli_options(int, char* [], cli_options_t*);
static void
signal_handler(int);
...
static void
error_msg(const std::string& self)
{
  std::cout << "Try \'" << self << " --help\' for more information.\n";
}

static void
help_msg(const std::string& self)
{
...
static bool
parse_cli_options(int argc, char* argv[], cli_options_t* cli_options)
{
  int opt, index;
