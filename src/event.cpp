...
void
Event::Handler::receiveEvent(const Event::Object*)
{}
...
void
Event::RTHandler::receiveEventRT(const Event::Object*)
{}
...
void
Event::Manager::postEvent(const Object* event)
{
...
void
Event::Manager::registerHandler(Handler* handler)
{
  Mutex::Locker lock(&mutex);
...
void
Event::Manager::unregisterHandler(Handler* handler)
{
  Mutex::Locker lock(&mutex);
...
void
Event::Manager::registerRTHandler(RTHandler* handler)
{
  rthandlerList.insert(rthandlerList.end(), *handler);
}

void
Event::Manager::unregisterRTHandler(RTHandler* handler)
{
