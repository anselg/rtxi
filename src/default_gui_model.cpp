...
void
DefaultGUIModel::createGUI(DefaultGUIModel::variable_t* var, int size)
{
...
QString
DefaultGUIModel::getComment(const QString& name)
{
...
void
DefaultGUIModel::setComment(const QString& name, QString comment)
{
  std::map<QString, param_t>::iterator n = parameter.find(name);
  if (n != parameter.end() && (n->second.type & COMMENT)) {
...
QString
DefaultGUIModel::getParameter(const QString& name)
{
  std::map<QString, param_t>::iterator n = parameter.find(name);
...
void
DefaultGUIModel::setParameter(const QString& name, double value)
{
  std::map<QString, param_t>::iterator n = parameter.find(name);
  if ((n != parameter.end()) && (n->second.type & PARAMETER)) {
...
void
DefaultGUIModel::setParameter(const QString& name, const QString value)
{
  std::map<QString, param_t>::iterator n = parameter.find(name);
  if ((n != parameter.end()) && (n->second.type & PARAMETER)) {
...
void
DefaultGUIModel::setState(const QString& name, double& ref)
{
  std::map<QString, param_t>::iterator n = parameter.find(name);
...
void
DefaultGUIModel::setEvent(const QString& name, double& ref)
{
  std::map<QString, param_t>::iterator n = parameter.find(name);
...
void
DefaultGUIModel::doSave(Settings::Object::State& s) const
{
