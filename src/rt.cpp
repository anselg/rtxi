...
int
RT::System::SetPeriodEvent::callback(void)
{
  int retval;
...
void
RT::Device::setActive(bool state)
{
  if (RT::OS::isRealtime())
    active = state;
  else {
...
void
RT::Thread::setActive(bool state)
{
  if (RT::OS::isRealtime())
    active = state;
  else {
...
int
RT::System::setPeriod(long long period)
{
...
void
RT::System::foreachDevice(void (*callback)(RT::Device*, void*), void* param)
{
...
void
RT::System::foreachThread(void (*callback)(RT::Thread*, void*), void* param)
{
...
int
RT::System::postEvent(RT::Event* event, bool blocking)
{
...
void
RT::System::insertDevice(RT::Device* device)
{
  if (!device) {
...
void
RT::System::removeDevice(RT::Device* device)
{
  if (!device) {
...
void
RT::System::insertThread(RT::Thread* thread)
{
  if (!thread) {
...
void
RT::System::removeThread(RT::Thread* thread)
{
  if (!thread) {
...
RT::System::execute(void)
{
  ...
  if (RT::OS::setPeriod(task, period)) {
    ERROR_MSG("RT::System::execute : failed to set the initial period of the "
              "realtime thread\n");
    return;
  }
