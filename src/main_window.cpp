...
QAction*
MainWindow::createFileMenuItem(const QString& text)
{
...
void
MainWindow::setModuleMenuItemParameter(QAction* action, int parameter)
{
...
void
MainWindow::changeModuleMenuItem(QAction* action, QString text)
{
  action->setText(text);
}
...
void
MainWindow::createSystemMenu()
{
  systemMenu = menuBar()->addMenu(tr("&System"));
}

void
MainWindow::createWindowsMenu()
{
...
void
MainWindow::createMdi(QMdiSubWindow* subWindow)
{
  mdiArea->addSubWindow(subWindow);
}

void
MainWindow::createHelpActions()
{
...
void
MainWindow::utilitiesMenuActivated(QAction* id)
{
...
void
MainWindow::windowsMenuActivated(QAction* id)
{
...
void
MainWindow::modulesMenuActivated(QAction* id)
{
...
void
MainWindow::fileMenuActivated(QAction* id)
{
  // Annoying but the best way to do it is to tie an action to the entire menu
