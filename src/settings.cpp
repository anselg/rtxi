...
Settings::Object::State::State(Settings::Object::ID n)
  : id(n){};

Settings::Object::State::~State(void){};

double
Settings::Object::State::loadDouble(const std::string& name) const
{
  double value = 0.0;
  std::istringstream s;
...
int
Settings::Object::State::loadInteger(const std::string& name) const
{
  int value = 0;
  std::istringstream s;
  std::map<std::string, std::string>::const_iterator n;
...
std::string
Settings::Object::State::loadString(const std::string& name) const
{
  std::string value = "";
  std::map<std::string, std::string>::const_iterator n;
...
void
Settings::Object::State::saveDouble(const std::string& name, double value)
{
  std::ostringstream s;
  s << value;
  paramMap[name] = s.str();
...
void
Settings::Object::State::saveInteger(const std::string& name, int value)
{
  std::ostringstream s;
  s << value;
  paramMap[name] = s.str();
...
Settings::Object::State::loadState(const std::string& name) const
{
  State value;
...
QDomElement
Settings::Object::State::xml(QDomDocument& doc) const
{
...
void
Settings::Object::State::xml(const QDomElement& e1)
{
  paramMap.clear();
  stateMap.clear();
...
Settings::Object::State
Settings::Object::save(void) const
{
  State s(id);
  doSave(s);
  return s;
...
void
Settings::Object::deferred(const Settings::Object::State& s)
{
  doDeferred(s);
}

Settings::Object*
Settings::Manager::getObject(Settings::Object::ID id) const
{
...
void
Settings::Manager::foreachObject(void (*callback)(Object*, void*), void* param)
{
  Mutex::Locker lock(&mutex);
...
int
Settings::Manager::load(const std::string& filename)
{
...
static void
saveState(Plugin::Object* plugin, void* param)
{
...
int
Settings::Manager::save(const std::string& filename)
{
  QDomDocument doc;
  QDomElement e;
...
void
Settings::Manager::acquireID(Settings::Object* object, Settings::Object::ID id)
{
  Mutex::Locker lock(&mutex);
...
void
Settings::Manager::releaseID(Settings::Object* object)
{
  Mutex::Locker lock(&mutex);
...
void
Settings::Manager::removeObject(Settings::Object* object)
{
  Mutex::Locker lock(&mutex);
