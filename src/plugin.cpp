...
std::string
Plugin::Object::getLibrary(void) const
{
  return library;
}

void
Plugin::Object::unload(void)
{
  Plugin::Manager::getInstance()->unload(this);
}

Plugin::Object*
Plugin::Manager::load(const QString& library)
{
  ...
  if (plugin->magic_number != Plugin::Object::MAGIC_NUMBER) {
    ERROR_MSG("Plugin::load : the pointer returned from %s::createRTXIPlugin() "
...
void
Plugin::Manager::unload(Plugin::Object* plugin)
{
  if (!plugin) {
...
void
Plugin::Manager::foreachPlugin(void (*callback)(Plugin::Object*, void*),
                               void* param)
{
  Mutex::Locker lock(&mutex);
...
void
Plugin::Manager::insertPlugin(Plugin::Object* plugin)
{
  if (!plugin) {
...
void
Plugin::Manager::removePlugin(Plugin::Object* plugin)
{
  if (!plugin) {
...
void
Plugin::Manager::customEvent(QEvent* e)
{
...
Plugin::Manager*
Plugin::Manager::getInstance(void)
{
  if (instance)
    return instance;
