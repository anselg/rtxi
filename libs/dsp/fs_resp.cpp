...
//=====================================================================
void
FreqSampFilterResponse::ComputeMagResp(FreqSampFilterDesign* filter_design,
                                       int db_scale)
{
  int index, L, n;
  double lambda, work;
...
void
FreqSampFilterResponse::NormalizeResponse(int db_scale)
{
  int n;
  double biggest;
...
double*
FreqSampFilterResponse::GetMagResp(void)
{
  return (Mag_Resp);
}

void
FreqSampFilterResponse::DumpMagResp(ofstream* output_stream)
{
  int n;
