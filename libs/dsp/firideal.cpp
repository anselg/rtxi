...
void
FirIdealFilter::Ideal_Lowpass(double lambda1)
{
  int n, n_max;
  double m;
...
void
FirIdealFilter::Ideal_Highpass(double lambda1)
{
  int n, n_max;
  double m;
...
void
FirIdealFilter::Ideal_Bandpass(double lambda1, double lambda2)
{
  int n, n_max;
  double m;
...
void
FirIdealFilter::Ideal_Bandstop(double lambda1, double lambda2)
{
  int n, n_max;
  double m;
