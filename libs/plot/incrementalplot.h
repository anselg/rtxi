/*
 * IncrementalPlot, derived from QwtPlot, contains a container class for
 * growing data and allows you to plot data asynchronously of any size from a
 * single (x,y) point to a series of points. It will also draw lines, e.g. data
 * fits, holding line data in a separate structure.
 */
