...
SystemControl::SystemControl(void)
{
  MainWindow::getInstance()->createSystemMenuItem(
    "Control Panel", this, SLOT(createControlPanel(void)));
}
...
void
SystemControl::createControlPanel(void)
{
...
void
SystemControl::removeControlPanel(SystemControlPanel* panel)
{
...
SystemControl*
SystemControl::getInstance(void)
{
  if (instance)
    return instance;
